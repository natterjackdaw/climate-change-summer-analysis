...
def one_summery_summary_plot(
    ...
    """
    This creates one plot per figure.
    It was created to display areas where:
    * temperature was hottest so far that year (since 1950) with hatching
    * percentile of temperature that year (compared to 1950-20) with colour
    ...
    * an array of percentile values
    ...
    # TODO: this legent ends up in the wrong place!
    # legend_elements = [
